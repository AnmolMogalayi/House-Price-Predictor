...
from .serializers import HouseFeatureSerializer,PredictionHistorySerializer,PredictionResponseSerializer
...
def predicted_price(request):
    ...
    try:
        ...
        response_serializer = PredictionResponseSerializer(prediction_result)
